        ...
        <div className="container">
            ...
            <div className="row p-5  border-top">
                ...
                <div className="col-5 mt-5 fs-5">
                    ...
                    <a href="https://rainmatter.in/" style={{ color: '#00BFFF', textDecoration: 'none' }} >Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets. <br /> <br />

                    And yet, we are always up to something new every day. Catch up on the latest updates on our blog or see what the media is saying about us or learn more about our business and product <a href="" style={{ color: '#00BFFF', textDecoration: 'none' }} >philosophies</a>.
                </div>
                <div className="col-1"></div>
            </div>
